...
<?php }else{ ?>
    <span class="badge badge-danger"><i class="fa fas-info-circle"></i>Data absensi masih kosong, silahkan input data kehadiran pada bulan dan tahun yang anda pilih </span>
<?php  }  ?>
